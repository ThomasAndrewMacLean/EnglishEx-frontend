<template>
    <section>
        <div v-if="exercise" class="wrap">
            ...
            <div v-if="exercise.info" class="notification is-link">{{exercise.info}}</div>
                ...
                <div class="columns">
                    <div class="column">
                        <div :class="{ 'doubleChecked': checked[index] }" class="partA" v-for="(e,index) in columnA"
                            :key="'columnA-' + index">
                            <span v-if="checked[index]" class="checkie">
                                <i class="fas fa-check-double"></i>
                            </span>
                            {{e}}
                            <span v-if="checked[index]" @click.stop="unDoubleCheck(e, index)" class="undo-double-check">
                ...
                <div class="columns">
                    <div class="column">
                        <div class="partA exD" v-for="(e, index) in columnA" :key="e">
                            ...
                            <div v-if="answers && answers[index] === ''" class="good-answer-d">
                                <i class="far fa-check-circle"></i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="columns">
                    ...
                    <div class="column">
                        <div class="partBNoHover" v-for="(e, index) in columnB" :key="e + '-' + index">
                            <span v-if="showTypeE === index">{{e}}</span>
                        </div>
                    </div>
                </div>
            </div>
